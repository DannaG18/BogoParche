...
const PLACES = [
  ...
  },
  {
    ...
    category: 'Naturaleza',
    zone: 'Centro',
    image: 'https://images.unsplash.com/photo-1589417277649-16ebbc9cebe3?auto=format&fit=crop&q=80&w=800',
  ...
  },
  {
    ...
    category: 'Historia',
    zone: 'La Candelaria',
    image: 'https://images.unsplash.com/photo-1629851613049-74d3da9e68c8?auto=format&fit=crop&q=80&w=800',
  ...
  },
  {
    ...
    category: 'Naturaleza',
    zone: 'Engativá',
    image: 'https://images.unsplash.com/photo-1588698188185-18861d8b9415?auto=format&fit=crop&q=80&w=800',
  ...
  { id: 'p8', title: 'Museo Botero', category: 'Museos', zone: 'La Candelaria', image: 'https://images.unsplash.com/photo-1577717903315-1691ae25ab3f?auto=format&fit=crop&q=80&w=800', description: 'Alberga una de las colecciones de arte más importantes de Latinoamérica, donada por el artista Fernando Botero.', safety: 'Tranquilo', rating: 4.9, schedule: 'Lun - Sáb: 9am - 7pm / Dom: 10am - 5pm' },
  { id: 'p9', title: 'Park Way', category: 'Cultura', zone: 'Teusaquillo', image: 'https://images.unsplash.com/photo-1499856871958-5b9627545d1a?auto=format&fit=crop&q=80&w=800', description: 'Un parque lineal rodeado de árboles inmensos, teatros, cafés independientes y librerías. El corazón cultural de Teusaquillo.', safety: 'Precaución de noche', rating: 4.5, schedule: 'Abierto 24h' },
  { id: 'p10', title: 'Planetario de Bogotá', category: 'Cultura', zone: 'Centro Internacional', image: 'https://images.unsplash.com/photo-1532094349884-543bc11b234d?auto=format&fit=crop&q=80&w=800', description: 'Centro cultural y científico con proyecciones láser astronómicas, exhibiciones interactivas y eventos musicales.', safety: 'Tranquilo', rating: 4.6, schedule: 'Mar - Dom: 10am - 5pm' },
  { id: 'p11', title: 'Pasaje Rivas', category: 'Historia', zone: 'Centro', image: 'https://images.unsplash.com/photo-1519999482648-25049ddd37b1?auto=format&fit=crop&q=80&w=800', description: 'El primer centro comercial de Bogotá (1893). Un lugar laberíntico fascinante para comprar artesanías típicas colombianas.', safety: 'Ir en grupo', rating: 4.3, schedule: 'Lun - Sáb: 9am - 6pm' },
  { id: 'p12', title: 'Quebrada La Vieja', category: 'Naturaleza', zone: 'Chapinero', image: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&q=80&w=800', description: 'Sendero ecológico en los cerros orientales perfecto para senderismo matutino, rodeado de bosque de niebla.', safety: 'Tranquilo', rating: 4.8, schedule: 'Mar - Dom: 5am - 10am' },
  { id: 'p13', title: 'Café Cultor', category: 'Cafés', zone: 'Quinta Camacho', image: 'https://images.unsplash.com/photo-1497935586351-b67a49e012bf?auto=format&fit=crop&q=80&w=800', description: 'Experimenta el verdadero café de especialidad colombiano en una hermosa casa estilo Tudor.', safety: 'Tranquilo', rating: 4.7, schedule: 'Lun - Sáb: 8am - 7pm' },
  { id: 'p14', title: 'Plaza de Bolívar', category: 'Historia', zone: 'Centro', image: 'https://images.unsplash.com/photo-1552554522-83b6f8f5379b?auto=format&fit=crop&q=80&w=800', description: 'El centro neurálgico del poder en Colombia, rodeada por el Capitolio, la Catedral Primada y el Palacio de Justicia.', safety: 'Precaución de noche', rating: 4.5, schedule: 'Abierto 24h' },
